...
```
Piriyajitakonkij, Maytus, Sirawaj Itthipuripat, <br>Ian Ballard, and Ioannis Pappas. <br>"What makes a face looks like a hat: Decoupling low-level and high-level Visual Properties with Image Triplets." arXiv preprint arXiv:2409.02241 (2024).
```
